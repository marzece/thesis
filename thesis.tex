...
% DISSERTATION TITLE
\title{Measurement of $\ce{^{8}B}$ Solar Neutrinos In the SNO+ Water Phase And Development
of a Modified Vacuum Neutrino Mixing Model}
...
%YOUR ADVISOR
\supervisor[Professor, Physics and Astronomy]{J.R. Klein}

% Your Department Graduate chair
\gradchair[Professor, Physics and Astronomy]{J.R. Klein}
