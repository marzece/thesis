...
\newcommand{\urltilde}{\kern -.05em\lower .7ex\hbox{\large{~}}\kern -.08em}
\catcode`~=13 % revert back to treating tilde (~) as an active character

\usepackage{amssymb,amsmath} %for multi-line eqns and probably other stuff
\usepackage{physics} % for bra-ket notation & more
\usepackage{mhchem} % chemical equations
\usepackage{feynman} % feynman diagrams
\usepackage{graphicx} %
\usepackage{subcaption} % subfigures
\usepackage{booktabs} % for midrule/toprule/bottomrule
\usepackage[detect-all]{siunitx} % for \numrange
...
% DISSERTATION TITLE
\title{Measurement of $\ce{^{8}B}$ Solar Neutrinos In the SNO+ Water Phase And A
Model of Vacuum-Enhanced Neutrino Mixing}
...
% PDF information
\PDFSubject{Physics}
\PDFkeywords{science, physics, neutrino}

%YOU
\author[marzece@sas.upenn.edu]{Eric Marzec}

% Degree information
\DegreeDate{2019} % expected year of graduation.
...
%YOUR ADVISOR
\supervisor[Professor, Physics and Astronomy]{Joshua R. Klein}

% Your Department Graduate chair
\gradchair[Professor, Physics and Astronomy]{Joshua R. Klein}
...
\firstcomittee[Professor, Physics and Astronomy]{Christopher Mauger}
\secondcomittee[Professor, Physics and Astronomy]{Joe Kroll}
\thirdcomittee[Professor, Physics and Astronomy]{Justin Khoury}
\fourthcomittee[Professor, Physics and Astronomy]{Masao Sako}
%\fifthcomittee[Professor, Physics and Astronomy]{}
...
\part{$\ce{^{8}B}$ Neutrino Flux Measurement}
\include{introduction/introduction}
\include{detector/detector}
\include{sigex/sigex}
\part{Vacuum-Enhanced Mixing}
\include{chameleons/chameleons}
