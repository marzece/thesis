...
% DISSERTATION TITLE
\title{A Measurement of $\ce{^{8}B}$ Solar Neutrinos With SNO+ And Development
of a Modified Neutrino Vacuum Mixing Model}
...
%YOU
\author[marzece@sas.upenn.edu]{Eric Marzec} %[your email address]{your name}

% Degree information
\DegreeDate{2018} % expected year of graduation.
