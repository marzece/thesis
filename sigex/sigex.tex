...
The direction ($\vec{d}$), time ($\t_{0}$), and poition ($\vec{p}$) are determined by performing a likelihood
...
Scanning many positions allowed for a position depedent evaluation of
systematics.
