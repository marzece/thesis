...
\end{equation}
and using a PDF for $t^{res}$ determined from simulation, $P(t^{res})$.
...
\subsubsection{Solar Neutrino Fluxes}
...
\subsubsection{Run Selection}
\subsubsection{Event Selection}
\subsubsection{Hit Cleaning}
...
\subsubsection{Crate Isotropy Cut}
The Crate Isotropy Cut is designed to remove events that originate
from noise
\subsubsection{Flasher Geometry Cut}
\subsubsection{ITC Timespread Cut}
