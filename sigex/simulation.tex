...
The simulation package used is called RAT, it is a Geant4~\citep{geant4} based simulation that
...
The flux is predicted by BS05-OP~\citep{bs_ssm} using the GS98~\citep{gs98} solar
