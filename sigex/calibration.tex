...
Figure~\ref{fig:n16_position_fit} shows an example of this distribution and fit for a central $\ce{^{16}N}$
dataset.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.78\textwidth]{Position_data_vs_mc}
\caption[]{}
\label{}
\end{figure}
