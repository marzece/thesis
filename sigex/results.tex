...
parameters given in Ref.~\citep{pdg2016} and the solar production and electron
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{globalfit_spectrum}
    \caption[Expected Scintillator Phase SNO+ Solar Neutrino Spectrum]{}
