...
Solar neutrino fluxes are constrainted by the GS98SF2~\citep{XXX} solar model calculations.
Reactor neutrino results from Daya Bay~\citep{}, KamLAND~\citep{}, Reno~\citep{}
are also used to constrain neutrino mixing parameters.
Only the reactor neutrino results from KamLAND are used, though
the experiment has made solar neutrino measurements as well~\citep{kamland_solar, kamland_b8}.
