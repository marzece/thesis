...
Sun to a detector at Earth. Then second calculates the evolution
of the mixing eigenstates for solar neutrinos, and does not simulate individual
neutrinos.
These two methods will be discusssed in greater detail in the following sections,
...
The reason for this sampling....

Since the MC sampling produces energy and production radius values that fall
