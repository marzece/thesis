...
Following this a gradient descent fit was done in four different manner,
...
Nonetheless, these results show that the vacuum-enhanced mixing model
can signficantly reduce the tension between the KamLAND and solar measurements values
for $\Delta m^{2}_{21}$.
...
model and the standard MSW-LMA model is $3.75$, or $\Delta \chi^{2}/\mathrm{d.o.f}1.87$.
