...
\subsection{TUBII}
\label{sec:tubii}
I designed an auxillary trigger board for SNO+ called the Trigger
Utility Board Mk.II (TUBII) the spritual sucessor to Trigger Utility Board
from SNO\@. 
...
trigger system. It can recieves raw-trigger signals from the MTCA+s and
