...
%The photons can then be detected by the SNO+ PMT array, and the pattern
...
In practice, it is possible for a channel's GTID to become out of sync with the GTIDs of
all other channels.
...
%customizable trigger logic to them and emit its own raw-trigger pulses which are
%sent to the MTCD\@.
...
%The gain of the three different analog is 1:1, 1:3.6 and 1:10. XXX includes this?
