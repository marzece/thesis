...
target medium.
For the entirety of this work the target medium is light-water ($\ce{H_{2}O}$);
this phase is referred to as the ``water phase''.
Following this the water is to be replaced by a liquid-scintillator,
LAB-PPO~\cite{mchen_labppo}, that will be the ``pure scintillator phase'' or
...
a lower density than the surrounding water volume, cause significant buoyant
forces on the AV\@.
...
backgrounds, and so are ignored typically.

The cross-section for the ES interaction is discussed in~\ref{sec:es_xsec}.
