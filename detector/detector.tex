...
target medium.
For this work the target medium was light-water, $\ce{H_{2}O}$, known as the
``water phase''.
Following this the water is to be replaced by a liquid-scintillator, LAB-PPO,
...
%TODO FIND source to comment on scintillator for (neutrino)particle detection
% so i don't have to write about it.
