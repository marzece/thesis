...
%The standard model of particle physics is our currently our best way of understanding
...
In princible the charged-current interaction is available to neutrinos of all
...
The ``hierarchy'' of the neutrino masses, i.e.\ which
...
The potential associated with the charged-current ES interaction
is given by
\begin{equation}
...
%The adiabaticity of neutrino evolution will be discussed further in Part~\ref{sec:partII}.
...
%The CNO-cycle has the interesting property of conserving the atomic abundance of the atomic
...
%and helioseismological measurements of the speed of sound in or across the Sun.  The speed of sound measurements can be used to estimate the required chemical composition.
...
Neutrinos created in the solar core can experience significant matter enhanced
...
%
%The Homestake experiment~\citep{homestake} ran from 1970 to 1990. %(XXX? Is that right??)
...
A few main results of the SNO experiment are summarized in
