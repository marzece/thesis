...
The Homestake experiment~\cite{homestake} ran from 1970 - 1990. %(XXX? is that right??)
...
The results of the SNO experiment are summarized in Figures~\ref{fig:sno_cross_graph}
and~\ref{fig:sno_pee}.
...
\begin{equation*}
\Phi_{\ce{^{8}B}} = 5.25\pm0.16(stat.)^{+0.11}_{−0.13}(syst.))\times10^6\mathrm{cm}^{-2}\mathrm{s}^{-1}\text{\cite{sno_combined}.}
\end{equation*}
...
The SuperK experiment separates their dataset into 4 subsets, called
SuperK-I~\cite{superk1}, SuperK-II~\cite{superk2}, SuperK-III~\cite{superk3}, SuperK-IV~\cite{superk4},
