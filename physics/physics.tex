...
The persistent deficit measured by the Homestake experiment
...
Figures~\ref{fig:sno_cross_graph} and~\ref{fig:sno_pee}.
...
effective $\nu_{e}$ flux and $\nu_{\mu,\tau}$ flux; figure from~\cite{sno_second}.
 (b) The combined best fit survival probability from the combined three phase SNO
analysis (Ref.~\cite{sno_combined}), the red band is the best fit and uncertainty
