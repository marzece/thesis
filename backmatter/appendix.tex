...
related to the PEDESTAL signal on the FEC, there's reason to believe these sorts
...
This value is called the follower probability, $P_{F}(N_{1}, N_{2}, \Delta t)$.
...
could serve as a background to the solar or nucleon decay analysis,
...
The reason for the two cut regions is that at lower nhit the signal
...
This search uses only data from Solar experiments for the
likelihood.
...
Performing the fit this way yielded the best fit value
